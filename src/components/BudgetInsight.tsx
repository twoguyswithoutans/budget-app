...
export default function DownloadPDFButton() {
    ...
    useEffect(() => {
        ...
        if(expensesData) {
            setExpenses(expensesData.sort((a: { date: string; }, b: { date: string; }) => parseISO(a.date).getTime() - parseISO(b.date).getTime()));
        }
    }, []);
                        ...
                        <div className="w-full flex flex-col">
                            <div className="py-10 flex flex-col md:flex-row">
                                ...
                                <div className="w-full my-0 md:mx-4">
                                    ...
                                    <div className="rounded w-full md:w-full my-4 p-4 flex flex-col justify-center items-center text-background bg-foreground border border-foreground">
                                        <div className="text-lg font-semibold text-center">Number of Category Limits:</div>
                                        <div className="text-xl font-black">{categoryLimit?.length || 0}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
